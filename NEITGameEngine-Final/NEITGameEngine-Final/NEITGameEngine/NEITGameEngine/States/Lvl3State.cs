...
{
    public class Lvl3State:BaseGameState
    {
        ...
        public Lvl3State(ScoreMenu menu, SpriteManager mgr)
        {
        ...
        public override void LoadContent(ContentManager contentManager)
        {
            ...
            _map = new DynamicGroundMap(contentManager, "FINALLVL3.json", "newSpriteSheet");
            AddGameObject(_map);

            winTrigger = new Rectangle(new Point(2944, 768), new Point(128, 128));
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (_playerSprite.BoxCollider.Intersects(winTrigger))
            {
                ...
                SwitchState(new WinState(_scoreMenu._score.ToString()));
            }
