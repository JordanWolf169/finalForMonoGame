...
{
    public class Lvl2State:BaseGameState
    {
        ...
        public Lvl2State(ScoreMenu menu, SpriteManager mgr)
        {
            scoreToPass = menu._score;
            _spriteManager = mgr;
        }
        ...
        public override void LoadContent(ContentManager contentManager)
        {
            ...
            _map = new DynamicGroundMap(contentManager, "FINALLVL2.json", "newSpriteSheet");
            AddGameObject(_map);

            winTrigger = new Rectangle(new Point(2432, 512), new Point(128, 128));


            //Player Sprite
            //_spriteManager = new SpriteManager();
            _playerSprite = new PlayerSprite(_spriteManager, new(/*Globals.windowSize.X/2*/32, /*Globals.windowSize.Y/2*/ 350), 1000f, new(1, 0), contentManager.Load<Texture2D>("bulletSprite"), _map._groundTiles[0, 0]);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (_playerSprite.BoxCollider.Intersects(winTrigger))
            {
                ...
                SwitchState(new Lvl3State(_scoreMenu, _spriteManager));
            }
